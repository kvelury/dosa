...
struct SettingsView: View {
    ...
    private static let providers = ["Gemini", "Anthropic", "OpenAI"]
            ...
            Form {
                ...
                Section("LLM Provider") {
                    ...
                    if selectedProvider == "Gemini" {
                        ...
                        Text("\(selectedProvider) support is coming soon. Dosa currently uses Gemini for transcription and note generation.")
                            .font(.callout)
                            .foregroundStyle(.secondary)
                            .multilineTextAlignment(.leading)
                            .fixedSize(horizontal: false, vertical: true)
                ...
                Section {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Exports your settings as a JSON file you can import into Dosa on another machine. The API key is not included — enter it separately on the other machine.")
                            .font(.caption)
                            .foregroundStyle(.tertiary)
                            .multilineTextAlignment(.leading)
                            .fixedSize(horizontal: false, vertical: true)
