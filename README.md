...
- **Recording stays visible when you navigate away** — a persistent toast keeps the elapsed clock in view and offers a way back to the note that owns the capture. ⌘R still starts and stops from anywhere.
